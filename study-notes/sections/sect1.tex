...
\item \label{it:charge-premiums} Now suppose \faIcon{building} accepts his
application with standard premium charged. Then, \faIcon{user} will
periodically pay \defn{premiums} \faIcon{dollar-sign} to \faIcon{building}, in
...
\faIcon{piggy-bank} of the life insurance business!
...
\item endowment insurance \faIcon{clock}\textbar\faIcon{shield-alt}\textbar\faIcon{donate} and pure endowment \faIcon{donate}
\item temporary life annuity \faIcon{clock}\textbar\faIcon{hand-holding-usd}
\item certain-and-life (or guaranteed) annuity \faIcon{lock}\textbar\faIcon{clock}\textbar\faIcon{hand-holding-usd}
...
``savings element'' \faIcon{donate} (to benefit the policyholder
...
\item \defn{Temporary life annuity} is a term \faIcon{clock} annuity with periodic
...
\item \defn{Certain-and-life annuity} (or \defn{guaranteed annuity}) is a term
\faIcon{clock} annuity with periodic payments \faIcon{hand-holding-usd} to
the annuitant \faIcon{user} for \emph{at least} a guaranteed \faIcon{lock}
term (those payments are paid \emph{certainly}), and the payments continue
afterward as long as \faIcon{user} is alive.
...
For all the contracts here, premiums \faIcon{dollar-sign} are payable.
