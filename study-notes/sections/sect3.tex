...
present value (also known as \defn{actuarial present value} (APV)).
...
\node[draw, violet] (dl) at (2.5,-3) {deferred contracts};
...
\item The \defn{present value random variable} (p.v.r.v.) (i.e., present value
of benefits \faIcon{money-bill-wave} outgo) of the policy is
\[
Z=v^{T_x}=e^{-\delta T_x}.
\]
...
or \(\displaystyle\int_{0}^{n}e^{-\delta t}\px[t]{x}\mu_{x+t}\dd{t}\)
...
\end{pf}
\end{enumerate}
\subsection{Deferred Life Insurance}
...
formula in \labelcref{it:gen-apv-fmla}. Here we shall discuss two special
cases:
\begin{itemize}
...
\fill[] (8,0) circle [radius=0.05]
node[below] {4};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (0,0) -- (1.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(1\)};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (2,0) -- (3.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(2\)};
\node[font=\large] () at (5,0.8) {...};
\end{tikzpicture}
...
\fill[] (8,0) circle [radius=0.05]
node[below] {4};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (0,0) -- (0.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(\frac{1}{2}\)};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (1,0) -- (1.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(1\)};
\node[font=\large] () at (3,0.8) {...};
\end{tikzpicture}
\item increasing continuously: death benefit to be paid at any time \(t\) is \(t\);

\begin{tikzpicture}[scale=0.7]
\begin{axis}[domain=0:10, ylabel={\color{brown}\faIcon{money-bill-wave}}, xlabel=Time, ylabel style={rotate=90}]
\addplot[brown, thick]{x};
\end{axis}
\end{tikzpicture}
...
node[below] {4};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (0,0) -- (1.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(4\)};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (2,0) -- (3.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(3\)};
\node[font=\large] () at (5,0.8) {...};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (6,0) -- (7.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(1\)};
\end{tikzpicture}
...
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(4\)};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (1,0) -- (1.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(3.5\)};
\node[font=\large] () at (4,0.8) {...};
\draw[brown, very thick, decorate,decoration={calligraphic brace, amplitude=5pt, raise=15pt}] (7,0) -- (7.9,0)
node[midway, above=0.7cm, font=\small] {\faIcon{money-bill-wave}: \(1\)};
\end{tikzpicture}
...
added on them to represent a variety of insurances (but of course the term
must be finite for decreasing insurances).
\item Here we do not include the case where the benefit varying frequency is
\emph{higher} than the insurance itself since in such case it may not be very
clear how changes in death benefits (strictly) \emph{between} the dying time
and the death benefit payment time (which may exist) should be handled.
\item The kinds of insurance usually encountered here are the ones where the
benefit varying and insurance ``frequencies'' are the same (located at the
``main diagonal'' for each of increasing \& decreasing case) --- the APV
...
We have
\begin{enumerate}
\item \(\displaystyle\DbA*_{\termxn}=\int_{0}^{n}\Ax*{\itop{x}:\angl{n-t}}\dd{t}\);\\
...
\node[] () at (1.5,3) {\(\displaystyle\int_{0}^{n}\Ax*{\itop{x}:\angl{n-t}}\dd{t}\)};
...
\begin{note}
As a special case, when \(n=1\), we have:
\begin{itemize}
\item \(\displaystyle \Ax{x}=v\qx{x}+v\px{x}\Ax{x+1}\);
\item \(\displaystyle \Ax{x}[(m)]=v^{\frac{1}{m}}\qx[\frac{1}{m}]{x}+v^{\frac{1}{m}}\px[\frac{1}{m}]{x}\Ax{x+\frac{1}{m}}[(m)]\).
\end{itemize}
\end{note}
