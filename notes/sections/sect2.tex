...
\defn{force of mortality} at time \(t\) (``modelled'' at age \(x\)), denoted by
\defn{\(\mu_x(t)\)}, is
\[
...
``\(\Leftarrow\)'': For any age \(x\) and any \(t,u\ge 0\),
firstly \cref{eq:select-table-req2} immediately holds. Next, consider:
\begin{itemize}
